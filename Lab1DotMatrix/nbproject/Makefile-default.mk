...
FINAL_IMAGE=${DISTDIR}/Lab1DotMatrix.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Lab1Code.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab1Code.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab1Code.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab1Code.o

# Source Files
SOURCEFILES=Lab1Code.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Lab1DotMatrix.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F883
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lab1DotMatrix.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab1Code.o: Lab1Code.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab1Code.o 
	${MP_AS} -mcpu=PIC16F883 -c \
	-o ${OBJECTDIR}/Lab1Code.o \
	Lab1Code.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Lab1DotMatrix.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F883 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Lab1DotMatrix.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
